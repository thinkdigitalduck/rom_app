...
frappe.ui.form.on("Cutlery Inventory Count", {
	refresh(frm) {
	...
	onload(frm) {
			...
			if (frm.is_new()) {
				...
				callback: function(res) {
					...
					// -----------------------------
					frappe.call({
					method: "rom_app.restaurant_ops_mgmt.api.get_cutlery_master_singltable_child_based_on_branch_category",
...
frappe.ui.form.on("Cutlery Inventory Count Child2", {
